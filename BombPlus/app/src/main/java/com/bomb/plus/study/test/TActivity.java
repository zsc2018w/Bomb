...
public class TActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_record.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isRecording) {
                    ...
                    MediaScannerConnection.scanFile(TActivity.this, new String[] { filename }, null, null);
                } else {
                    isRecording = true;
        ...
        button_open.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!filename.equals("")) {
                    ...
                    Log.d("txx","----->"+suffix+"---->"+filename);
                    String type = MimeTypeMap.getSingleton().getMimeTypeFromExtension(suffix);
                    Intent intent = new Intent(Intent.ACTION_VIEW);
                    Uri uri=FileProvider.getUriForFile(TActivity.this, BuildConfig.APPLICATION_ID + ".fileprovider",new File(filename));
                    Log.d("txx","type--->"+type+"uri--------->"+uri.toString());
        ...
        button_about.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new AlertDialog.Builder(TActivity.this).setIcon(R.mipmap.ic_launcher).setTitle("海天鹰录屏 V1.0")
