...
public class FloatWindowParamManager {
    ...
    private static boolean checkOps(Context context) {
        try {
            ...
            arrayOfObject1[2] = context.getApplicationContext().getPackageName();
    ...
    public static WindowManager.LayoutParams getFloatLayoutParam(Context context,boolean fullScreen, boolean touchAble) {
