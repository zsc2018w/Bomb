 ...
 * 首页
 */
data class EyeBean(val issueList: ArrayList<Issue>, val nextPageUrl: String, val nextPublishTime: Long, val newestIssueType: String, val dialog: Any){
        ...
        data class Item(val type: String, val data: Data?, val tag: String) : Serializable {
            ...
            data class Data(//val dataType: String,
                           ...
                           // val consumption: Consumption,
                            ...
                            //val playlists: Any,
                           // val header: Header,
                            val itemList:ArrayList<EyeBean.Issue.Item>
            ) : Serializable {
